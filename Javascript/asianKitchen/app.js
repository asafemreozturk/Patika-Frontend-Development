...
//Remove duplicates in category data
function removeDuplicates(data){
  return [...new Set(data)]
}

let cleanCategory=removeDuplicates(category);

cleanCategory.unshift("All");

function createButtons(){
  cleanCategory.forEach((cleanCategory)=> {
    let btton=document.createElement("button");
    btton.setAttribute("class","btn btn-outline-dark btn-item");
    btton.setAttribute("id",cleanCategory);

    btton.innerHTML=cleanCategory;
    btton.setAttribute("data-id",cleanCategory);
    container.appendChild(btton);
  });
} createButtons();
